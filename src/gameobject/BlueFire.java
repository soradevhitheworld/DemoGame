...
public class BlueFire extends Bullet{
    ...
    public BlueFire(float x, float y, GameWorldState gameWorld) {
        super(x, y, 60, 30, 0.5f, 50, gameWorld);
        forwardBulletAnim = CacheDataLoader.getInstance().getAnimation("bigbullet");
        backBulletAnim = CacheDataLoader.getInstance().getAnimation("bigbullet");
