...
public abstract class Human extends ParticularObject{
    ...
    protected boolean isSuperPowerActivated;
    ...
    public abstract void powerSuper();

    public boolean getIsSuperPowerActivated() {
    	return isSuperPowerActivated;
    }
    
    public void setIsSuperPowerActivated(boolean IsSuperPowerActivated) {
        this.isSuperPowerActivated = IsSuperPowerActivated;
    }
